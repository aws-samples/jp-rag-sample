...
function App() {
  ...
  const [pinnedTexts, setPinnedTexts] = useState<string[]>([]); // ピンドメされたテキスト一覧

  useEffect(() => {
    const tmpCurrentConversation: Conversation = {
    ...
    const tmpPinnedTexts: string[] = [
      "aaaa",
      "bbbb",
      "cccc"
    ]
    setPinnedTexts(tmpPinnedTexts)
  }, [])
