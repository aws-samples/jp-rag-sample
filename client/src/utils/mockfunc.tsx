...
import { Conversation, Filter } from "./interface";
import { DEFAULT_LANGUAGE, DEFAULT_SORT_ATTRIBUTE, DEFAULT_SORT_ORDER } from "./constant";

export function dummyHumanKendraAiConversation(): Conversation {
    return {
        ...
        kendraResponse: dummyQueryOutput(),
        aiResponse: {
            userUtterance: "こんばんは",
            aiUtterance: "よるですね",
...
export function dummyFullFilterOptions(): Filter[] {
    return [
        {
        ...
        },
        {
            ...
            title: "RANGE_DATE",
            options: [
                { "name": "min", value: new Date(2020, 8, 21, 21, 10, 5).toString() },
                { "name": "max", value: new Date(Date.now()).toString() },
            ],
...
export function dummyMinFilterOptions(): Filter[] {
    return [
        {
            filterType: "LAUNGUAGE_SETTING",
            title: "言語設定",
...
export function dummyQueryOutput(): QueryCommandOutput {
    return {
        "$metadata": {
            "httpStatusCode": 200,
        ...
        "FacetResults": [
            {
                DocumentAttributeKey: "files",
                DocumentAttributeValueCountPairs: [
                    {
                        DocumentAttributeValue: {
                            StringListValue: ["PDF", "DOCX", "DOC", "TXT"],
                        },
                        Count: 463
                    },
                    {
                        DocumentAttributeValue: {
                            StringListValue: ["TXT", "bbb", "dddd"],
                        },
                        Count: 100
                    }
                ],
            ...
            },
            {
                ...
                "DocumentAttributeValueType": "LONG_VALUE"
            },
            {
                DocumentAttributeKey: "timestamp",
                DocumentAttributeValueCountPairs: [
                    {
                        DocumentAttributeValue: {
                            DateValue: new Date(2020, 1, 3, 4, 5, 6)
                        },
                        Count: 363
                    },
                    {
                        DocumentAttributeValue: {
                            DateValue: new Date(2019, 1, 3, 4, 5, 6)
                        },
                        Count: 100
                    },
                    {
                        DocumentAttributeValue: {
                            DateValue: new Date(2018, 1, 3, 4, 5, 6)
                        },
                        Count: 50
                    },
                ],
                "DocumentAttributeValueType": "DATE_VALUE"
            },
            {
        ...
        "ResultItems": [
            {
                "AdditionalAttributes": [
                    {
                        ...
                        "Value": {
                            "TextWithHighlightsValue": {
                                ...
                                "Text": "日本の総理大臣は岸田文雄です。\n内閣総理大臣になるには国会で指名される必要があります。\n岸田文雄は国会で内閣総理大臣に指名されました。\n岸田文雄は首相官邸で仕事をします。\n岸田文雄は2021年から首相をしています。"
                            }
                        },
                ...
                "DocumentAttributes": [
                    {
                        "Key": "_source_uri",
                        "Value": {
                            "StringValue": "https://s3.us-east-1.amazonaws.com/aws-whitepaper-kendra-ysekiy-20220728/ファイルタイプ/sample.txt"
                        }
                    }
                ],
                "DocumentExcerpt": {
                ...
                "DocumentId": "s3://aws-whitepaper-kendra-ysekiy-20220728/ファイルタイプ/sample.txt",
                "DocumentTitle": {
                    "Highlights": [],
                    "Text": "sample"
                },
                "DocumentURI": "https://s3.us-east-1.amazonaws.com/aws-whitepaper-kendra-ysekiy-20220728/ファイルタイプ/sample.txt",
                "FeedbackToken": "_tNVVLj1ZpkIgtoeckZYsaUb9BJyfxAkeLtD0c34fY8Q6iuT3rPgpHiklQIAAAAADAAAEAAAAAAAAAAAAAAAAAB1zpTyDjlGm46vPYIdX3YI_____wAAAAEAAAAAAAAAAAAAAAEAAAF2sKPBdRORerk7CYoxW0sjqNH_hUgNEmHjjo3tu3BnicAUXc0nPDbMJXAIxeynsAKt-7W0CX-syVSo3mXHfmySnoBc0-Jm3Mo1q69wX4QWK0jc0fo2DuKO1xTUjsur8LAQa9Xx-35VPkMgaV25UOqja8GuTrQFzyMR1Dv1lN8ybR5nUgaCWWkHSF2LuGJW4Z-1o8tpzdIohFGpeaYNamLEFRittWKs91IkT9ZLrpEQVfw6ErGw29-0vzrshUYUJ4vmHuc4LlG6nw4iAWA6pkNaqcaJFYNHYT0FujiQf9pGcwX9FDMnCG4yLokYcWdof4EegCPVPdYIPHyuaiZ6KDuyAy0k4EoMAUcOoDZJ46pBkVmGRcVTy5WtSyl9p65_E54ScTcGc6C2yaiuFT2CblOYfPpU2XBKoXUxxarBYOBpi3IX08savWZb1V5ado79auWIPCHfEOPpfgIv7cTZcLBGAFY0pw2Arl-WuwnMDad5MAXYj5Xxa7RKgvlaaiDdPN1CbQmDm6bzAGcwZQIxAP7gL8zKM4KiEo2ixfMOCFTov3K03JMFJZ51TL5a9bvMV5HegWeu8GGbey8TfCWxYwIwVa8gCs95cg16Y1gQLA_EJEiO4NcjSVF0W3MQRO-mS_OSTh5CuRxAcFwnJmGYk_cG.2c710db0-e71f-491b-acf5-a03986e49f0b-faa2ed16-34ab-4e0d-b83f-4486acd67f10",
                "Format": "TEXT",
                "Id": "2c710db0-e71f-491b-acf5-a03986e49f0b-faa2ed16-34ab-4e0d-b83f-4486acd67f10",
                "ScoreAttributes": {
...
export function dummyHistory(): Conversation[] {
    return [
        {
            conversationType: "HUMAN_KENDRA",
            userInput: { "word": "首相" },
